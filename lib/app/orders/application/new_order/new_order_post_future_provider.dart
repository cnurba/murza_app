...
final newOrderPostFutureProvider = FutureProvider.autoDispose
    .family<ApiResult, BasketState>((ref, basketState) async {
      final orderRepository = ref.watch(orderRepositoryProvider);
      final result = await orderRepository.newOrder(basketState.toJson());
      return result;
    });
